...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/admin/css/pages-shoplogin.css" />
</head>
                    ...
                    <div class="tab-content tab-wraped">
                        ...
                        <div id="profile" class="tab-pane  active">
                            ...
                            <div class="otherlogin">
                                <div class="types">
                                    <ul>
                                        <li><img src="/admin/img/qq.png" width="35px" height="35px" /></li>
                                        <li><img src="/admin/img/sina.png" /></li>
                                        <li><img src="/admin/img/ali.png" /></li>
                                        <li><img src="/admin/img/weixin.png" /></li>
                                    </ul>
                                </div>
                                <span class="register"><a href="{{url('admins/register')}}" target="_blank">立即注册</a></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="/admin/js/pages/shoplogin.js"></script>
</body>
