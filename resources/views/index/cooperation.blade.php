...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/indexshop/css/pages-cooperation.css" />
</head>
            ...
            <div class="py-container">
                ...
                <div class="co-list">
                    <div class="showbanner">
                        <img src="/indexshop/img/_/01.png" alt="">
                    </div>
                    <div class="list-title">
                        <h1>成为供应商</h1>
                        <a class="sui-btn btn-bordered btn-shop " href="/index/sampling" target="_blank">立即入驻</a>
                    </div>
                    <div class="list">
                        <ul >
                            <li>成为供应商</li>
