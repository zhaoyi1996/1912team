...
购热销商品</em>
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="{{url('/index/cart')}}"  class="sui-btn  btn-danger addshopcar"  id="cartadd">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
						...
						<div id="index" class="tab-pane active">
							...
							<ul class="goods-list unstyled">
								<li>
									<div class="list-wrap">
										<div class="p-img">
											<img src="/indexshop/img/_/part01.png" />
										</div>
										<div class="attr">
								...
								<li>
									<div class="list-wrap">
										<div class="p-img">
											<img src="/indexshop/img/_/part02.png" />
										</div>
										<div class="attr">
											<em>Apple苹果iPhone 6s (A1699)</em>
										</div>
								...
								<li>
									<div class="list-wrap">
										<div class="p-img">
											<img src="/indexshop/img/_/part03.png" />
										</div>
										<div class="attr">
											<em>Apple苹果iPhone 6s (A1699)</em>
										</div>
						...
						<div class="good-suits">
							...
							<div class="fl suits">
								<ul class="suit-list">
									<li class="">
										<div id="">
											<img src="/indexshop/img/_/dp01.png" />
										</div>
										<i>Feless费勒斯VR</i>
    ...
    <input type="checkbox"><span>39</span>
									...
									<li class="">
										<div id=""><img src="/indexshop/img/_/dp02.png" /> </div>
										<i>Feless费勒斯VR</i>
										<label data-toggle="checkbox" class="checkbox-pretty">
    <input type="checkbox"><span>50</span>
									...
									<li class="">
										<div id=""><img src="/indexshop/img/_/dp03.png" /></div>
										<i>Feless费勒斯VR</i>
										<label data-toggle="checkbox" class="checkbox-pretty">
    <input type="checkbox"><span>59</span>
									...
									<li class="">
										<div id=""><img src="/indexshop/img/_/dp04.png" /></div>
										<i>Feless费勒斯VR</i>
										<label data-toggle="checkbox" class="checkbox-pretty">
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								...
								<div class="intro-detail">
									<img src="/indexshop/img/_/intro01.png" />
									<img src="/indexshop/img/_/intro02.png" />
									<img src="/indexshop/img/_/intro03.png" />
								</div>
							</div>
				...
				<div class="like-list">
					<ul class="yui3-g">
						...
						<li class="yui3-u-1-6">
							<div class="list-wrap">
								<div class="p-img">
									<img src="/indexshop/img/_/itemlike05.png" />
								</div>
								<div class="attr">
									<em>DELL戴尔Ins 15MR-7528SS 15英寸 银色 笔记本</em>
								</div>
						...
						<li class="yui3-u-1-6">
							<div class="list-wrap">
								<div class="p-img">
									<img src="/indexshop/img/_/itemlike06.png" />
								</div>
								<div class="attr">
									<em>DELL戴尔Ins 15MR-7528SS 15英寸 银色 笔记本</em>
								</div>
