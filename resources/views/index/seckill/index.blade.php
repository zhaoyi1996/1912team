...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/indexshop/css/pages-seckill-index.css" />
</head>
				...
				<div class="shortcut">
					<ul class="fl">
						...
						@if(session()->has("User_Info"))
                            ...
                            @else
                            <li class="f-item">请<a href="{{url('/index/login')}}" target="_blank">登录</a>　
                                <span><a href="{{url('/index/reg')}}" target="_blank">免费注册</a></span></li>
                            @endif
					</ul>
					<ul class="fr">
...
<script>
	...
	<script>
		$(".lijibutton").click(function(){
			...
			$.ajax({
				type:'get',
				url:"{{url('/index/seckill/seckilldo')}}",
