                    ...
                    <div class="list-items">
                       <dl>
                        ...
                        <dl>
                            ...
                            <dd><a href="/index/homePersonFootmark" class="list-active">我的足迹</a></dd>
                        </dl>
                        <dl>
                            <dt><i>·</i> 物流消息</dt>
                        </dl>
                        <dl>
                            <dt><i>·</i> 设置</dt>
                            <dd><a href="/index/homeSettingInfo">个人信息</a></dd>
                    ...
                    <div class="body">
                        ...
                        <div class="goods-list">
                            <ul class="yui3-g" id="goods-list">
                                 <li class="yui3-u-1-4">
                                        <div class="list-wrap">
                                            <div class="p-img"><img src="/indexshop/img/_/t.jpg" alt=''></div>
                        ...
                        <div class="like-list">
                            <ul class="yui3-g">
                                <li class="yui3-u-1-4">
                                    <div class="list-wrap">
                                        <div class="p-img">
                                            <img src="/indexshop/img/_/itemlike01.png" />
                                        </div>
                                        <div class="attr">
                                ...
                                <li class="yui3-u-1-4">
                                    <div class="list-wrap">
                                        <div class="p-img">
                                            <img src="/indexshop/img/_/itemlike02.png" />
                                        </div>
                                        <div class="attr">
                                ...
                                <li class="yui3-u-1-4">
                                    <div class="list-wrap">
                                        <div class="p-img">
                                            <img src="/indexshop/img/_/itemlike03.png" />
                                        </div>
                                        <div class="attr">
                                            <em>DELL戴尔Ins 15MR-7528SS 15英寸 银色 笔记本</em>
                                        </div>
                                ...
                                <li class="yui3-u-1-4">
                                    <div class="list-wrap">
                                        <div class="p-img">
                                            <img src="/indexshop/img/_/itemlike04.png" />
                                        </div>
                                        <div class="attr">
                                            <em>DELL戴尔Ins 15MR-7528SS 15英寸 银色 笔记本</em>
                                        </div>
