...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/indexshop/css/pages-shop.css" />
</head>
...
<script type="text/javascript" src="/indexshop/js/pages/shop.js"></script>
<script>
	   $(function(){
		   $("#code").hover(function(){
			   $(".erweima").show();
    ...
    <div class="py-container shop">
        ...
        <div class="shop-logo">
            <div class="fl logo-img">
                <img src="/indexshop/img/_/shop-logo.png" />
            </div>
            <div class="shop-vip">
                <div class="pay">
                    <img src="/indexshop/img/_/car.png" alt="">
                    <span>
                         全场免运费<br />
                         货到付款
                    </span>
        ...
        <div class="banner">
            <img src="/indexshop/img/_/shop-intro.png" alt="">
        </div>
        ...
        <div class="default-list">
            ...
            <div class="shop-part">
                <img src="/indexshop/img/_/shop-part.png" alt="">
            </div>
            <!--tab lists-->
        ...
        <div class="cd-top">
            <div class="top">
                <img src="/indexshop/img/_/gotop.png" />
                <b>TOP</b>
            </div>
            <div class="code" id="code">
                <span><img src="/indexshop/img/_/code.png"/></span>
            </div>
            <div class="erweima">
                <img src="/indexshop/img/_/erweima.jpg" alt="">
                <s></s>
            </div>
        </div>
    </div>
