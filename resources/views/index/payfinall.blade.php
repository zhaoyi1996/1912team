...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="/indexshop/css/pages-payfail.css" />
</head>
	...
	<body>
		...
		<div class="cart py-container">
			...
			<div class="payfail">
				<div class="fail">
					<h3><img src="/indexshop/img/_/fail.png" width="48" height="48">　支付失败，请稍后再试</h3>
					<div class="fail-text">
					<p>失败原因：不能使用金币购买！</p>
					<p>您可以先去　<a href="/index/index" target="_blank">品优购首页</a>　逛逛</p>
