...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/indexshop/css/pages-login.css" />
</head>
		...
		<div class="loginArea">
          ...
          自动登录
							...
							<div class="otherlogin">
								<div class="types">
									<ul>
										<li><img src="/indexshop/img/qq.png" width="35px" height="35px" /></li>
										<li><img src="/indexshop/img/sina.png" /></li>
										<li><img src="/indexshop/img/ali.png" /></li>
										<li><img src="/indexshop/img/weixin.png" /></li>
									</ul>
								</div>
								<span class="register"><a href="/index/register" target="_blank">立即注册</a></span>
							</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript" src="/indexshop/js/pages/login.js"></script>
</body>
